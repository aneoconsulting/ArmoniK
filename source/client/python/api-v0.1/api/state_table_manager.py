...
def state_table_manager(grid_state_table_service, grid_state_table_config, tasks_state_table_name, region=None):

    grid_state_table_config = grid_state_table_config.replace("'","\"")

    if grid_state_table_service == "DynamoDB":
        return StateTableDDB(grid_state_table_config, tasks_state_table_name, region)
