...
def try_to_acquire_a_task():
    ...
    try:
        ...
        logging.error("Unexpected error in claim_task_for_agent {} [{}]".format(
...
if __name__ == "__main__":
    ...
    try:
        ...
        logging.error("ClientError Agent Event Loop {} [{}] POD:{}".
                   format(e.response['Error']['Code'], traceback.format_exc(), SELF_ID))
        sys.exit(1)

    except Exception as e:
        logging.error("Exception Agent Event Loop {} [{}] POD:{}".
