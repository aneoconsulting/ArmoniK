            ...
            "template": {
                "spec": {
                    "containers": [{
                        ...
                        "args": [
                            f"""
                            cat /mongodb/certs/chain.pem
                            # Use the environment variables directly
                            # export MONGODB="mongodb://$MONGO_USER:$MONGO_PASS@$MONGO_HOST:$MONGO_PORT/?authSource=database&tls=true&tlsAllowInvalidCertificates=true&tlsCAFile=/mongodb/certs/chain.pem"
