...
processes.append(subprocess.Popen(f'docker build -t dockerhubaneo/armonik_compute_htcmock:{tag} -f Samples/HtcMock/GridWorker/src/Dockerfile .', shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE))
