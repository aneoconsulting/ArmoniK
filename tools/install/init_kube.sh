...
kubectl delete secret $ARMONIK_STORAGE_REDIS_SECRET_NAME
...
kubectl delete secret $ARMONIK_STORAGE_ACTIVEMQ_SECRET_NAME
...
kubectl delete secret $ARMONIK_STORAGE_MONGODB_SECRET_NAME
...
kubectl delete secret $ARMONIK_REDIS_SECRET_NAME
...
kubectl delete secret $ARMONIK_EXTERNAL_REDIS_SECRET_NAME
...
kubectl delete secret $ARMONIK_ACTIVEMQ_SECRET_NAME
...
kubectl delete secret $ARMONIK_MONGODB_SECRET_NAME
