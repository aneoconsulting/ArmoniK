...
namespace mock_subtasking
{
    public class Function
    {
        ...
        public string FunctionHandler(ClientTask inputTask, ILambdaContext context)
        {
			...
			string redis_endpoint_url = String.Format("{0},ssl={1},connectTimeout={2}", gridConfig.redis_endpoint_url, gridConfig.redis_with_ssl, gridConfig.connection_redis_timeouts);
