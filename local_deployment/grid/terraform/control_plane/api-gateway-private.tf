...
resource "aws_api_gateway_deployment" "htc_grid_private_deployment" {
  depends_on = [kubernetes_service.local_services, aws_api_gateway_method.htc_grid_private_submit_proxy_method,aws_api_gateway_method.htc_grid_private_result_proxy_method]
  rest_api_id = aws_api_gateway_rest_api.htc_grid_private_rest_api.id
  triggers = {
