  ...
  agent_config =<<EOF
{
  ...
  "public_api_gateway_url": "http://${module.control_plane.local_services_pod_ip}:${var.local_services_port}/restapis/${module.control_plane.private_api_gateway_id}/v1/_user_request_",
  "private_api_gateway_url": "http://${module.control_plane.local_services_pod_ip}:${var.local_services_port}/restapis/${module.control_plane.private_api_gateway_id}/v1/_user_request_",
