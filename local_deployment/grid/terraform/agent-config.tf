  ...
  agent_config =<<EOF
{
  ...
  "redis_endpoint_url": "${module.control_plane.redis_pod_ip}:${var.redis_port}",
  "redis_endpoint_url_without_ssl": "${module.control_plane.redis_without_ssl_pod_ip}:${var.redis_port_without_ssl}",
  "redis_with_ssl": "${var.redis_with_ssl}",
  "sqs_queue": "${local.sqs_queue}",
  "sqs_dlq": "${local.sqs_dlq}",
  "redis_ca_cert": "${var.redis_ca_cert_file}",
  "redis_client_pfx": "${var.redis_client_pfx_file}",
  ...
  "public_api_gateway_url": "${module.control_plane.local_services_pod_ip}:${var.local_services_port}/restapis/${module.control_plane.private_api_gateway_id}/v1/_user_request_",
  "private_api_gateway_url": "${module.control_plane.local_services_pod_ip}:${var.local_services_port}/restapis/${module.control_plane.private_api_gateway_id}/v1/_user_request_",
