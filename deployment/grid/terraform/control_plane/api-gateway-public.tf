...
resource "aws_api_gateway_integration_response" "htc_grid_public_submit_proxy_method_integration_response_200" {
  ...
  depends_on = [
    aws_api_gateway_method_response.htc_grid_public_submit_proxy_method_response_200,
    aws_api_gateway_rest_api.htc_grid_public_rest_api,
    aws_api_gateway_resource.htc_grid_public_submit_proxy
  ]
}
...
resource "aws_api_gateway_integration_response" "htc_grid_public_result_proxy_method_integration_response_200" {
  ...
  depends_on = [
    aws_api_gateway_method_response.htc_grid_public_result_proxy_method_response_200,
    aws_api_gateway_rest_api.htc_grid_public_rest_api,
    aws_api_gateway_resource.htc_grid_public_result_proxy
  ]
}

resource "aws_api_gateway_deployment" "htc_grid_public_deployment" {
  depends_on = [
    aws_api_gateway_method.htc_grid_public_submit_proxy_method,
    aws_api_gateway_method.htc_grid_public_result_proxy_method]
  rest_api_id = aws_api_gateway_rest_api.htc_grid_public_rest_api.id
  triggers = {
...
resource "aws_api_gateway_integration_response" "htc_grid_public_cancel_proxy_method_integration_response_200" {
  ...
  depends_on = [
    aws_api_gateway_method_response.htc_grid_public_cancel_proxy_method_response_200,
    aws_api_gateway_rest_api.htc_grid_public_rest_api,
    aws_api_gateway_resource.htc_grid_public_cancel_proxy]
}
