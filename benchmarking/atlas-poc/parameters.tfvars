...
configurations = {
  core = {
    env = {
      ...
      MongoDB__TableStorage__MaxPoolSize         = 1000
      MongoDB__TableStorage__WaitQueueTimeoutMS  = 1000
