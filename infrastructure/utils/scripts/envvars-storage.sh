...
export ARMONIK_STORAGE_REDIS_CERTIFICATES_DIRECTORY=$STORAGE_PATH/../../security/certificates
...
export ARMONIK_STORAGE_ACTIVEMQ_CERTIFICATES_DIRECTORY=$STORAGE_PATH/../../security/certificates
...
export ARMONIK_STORAGE_MONGODB_CERTIFICATES_DIRECTORY=$STORAGE_PATH/../../security/certificates
