...
resource "kubernetes_config_map" "fluent_bit_config" {
  ...
  data = {
    ...
    "input-kubernetes.conf"  = (local.fluent_bit_is_daemonset ? file("${path.module}/configs/input/input-kubernetes-daemonset-${local.fluent_bit_parser}.conf") : file("${path.module}/configs/input/input-kubernetes-sidecar.conf"))
