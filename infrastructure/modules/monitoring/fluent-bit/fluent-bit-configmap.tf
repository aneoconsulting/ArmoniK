...
resource "kubernetes_config_map" "fluent_bit_config" {
  ...
  data = {
    ...
    "output-http-seq.conf"   = (local.seq_use ? file("${path.module}/configs/output/output-http-seq.conf") : file("${path.module}/configs/output/output-default.conf"))
    "output-cloudwatch.conf" = (local.cloudwatch_use ? file("${path.module}/configs/output/output-cloudwatch.conf") : file("${path.module}/configs/output/output-default.conf"))
