locals {
  mongodb_image_name = var.mongodb_sharding != null ? (var.mongodb != null ? coalesce(var.mongodb.image_name, "bitnami/mongodb-sharded") : "bitnami/mongodb-sharded") : (var.mongodb != null ? coalesce(var.mongodb.image_name, "bitnami/mongodb") : "bitnami/mongodb")
  ecr_input_images = concat([
    ...
    [local.mongodb_image_name, var.mongodb != null ? var.mongodb.image_tag : "latest"],
