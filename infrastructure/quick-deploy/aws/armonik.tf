module "armonik" {
  ...
  #depends_on [module.aws_service_account, data.mongodbatlas_advanced_cluster.akaws]
  depends_on = [module.aws_service_account, mongodbatlas_advanced_cluster.akaws]
}
