module "armonik" {
  ...
  configurations = merge(var.configurations, {
    core = [module.sqs, module.activemq, module.mq, module.elasticache, module.s3_os, module.mongodb, module.mongodb_sharded, var.configurations.core, module.atlas_mongodb]
  })
