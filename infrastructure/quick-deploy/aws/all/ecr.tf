locals {
  ecr_input_images = concat([
    ...
    [var.admin_0_8_gui["api"].image, var.admin_0_8_gui["api"].tag],
    [var.admin_gui.image, var.admin_gui.tag],
    [var.admin_0_9_gui.image, var.admin_0_9_gui.tag],
    [var.admin_0_8_gui["app"].image, var.admin_0_8_gui["app"].tag],
