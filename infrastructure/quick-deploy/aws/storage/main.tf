...
module "s3_fs" {
  ...
  s3 = {
    ...
    kms_key_id                            = (var.s3_fs.kms_key_id != "" ? var.s3_fs.kms_key_id : module.kms[0].arn)
...
module "s3_os" {
  ...
  s3 = {
    ...
    kms_key_id                            = (can(coalesce(var.s3_os.kms_key_id)) ? var.s3_os.kms_key_id : module.kms[0].arn)
