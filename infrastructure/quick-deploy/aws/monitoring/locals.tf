...
locals {
  ...
  metrics_exporter_tag                = try(var.monitoring.metrics_exporter.tag, "0.6.1-jgsigtermprop.313.11c6a3e6")
  ...
  partition_metrics_exporter_tag                = try(var.monitoring.partition_metrics_exporter.tag, "0.6.1-jgsigtermprop.313.11c6a3e6")
