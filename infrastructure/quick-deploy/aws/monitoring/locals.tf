...
locals {
  ...
  metrics_exporter_tag                = try(var.monitoring.metrics_exporter.tag, "0.9.1")
  ...
  partition_metrics_exporter_tag                = try(var.monitoring.partition_metrics_exporter.tag, "0.9.1")
