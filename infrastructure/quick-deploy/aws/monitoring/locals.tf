...
locals {
  ...
  metrics_exporter_tag                = try(var.monitoring.metrics_exporter.tag, "0.6.1-SNAPSHOT.305.141fc8ae")
  ...
  partition_metrics_exporter_tag                = try(var.monitoring.partition_metrics_exporter.tag, "0.6.1-SNAPSHOT.305.141fc8ae")
