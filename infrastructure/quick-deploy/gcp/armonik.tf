module "armonik" {
  ...
  configurations = merge(var.configurations, {
    core = [module.activemq, module.pubsub, module.memorystore, module.gcs_os, module.mongodb, module.mongodb_sharded, var.configurations.core, module.atlas_mongodb]
  })
