locals {
  ...
  metrics_exporter_tag                = try(var.monitoring.metrics_exporter.tag, "0.6.1-jgimprovecancellation.341.8b7f2494")
  ...
  partition_metrics_exporter_tag                = try(var.monitoring.partition_metrics_exporter.tag, "0.6.1-jgimprovecancellation.341.8b7f2494")
