...
output "nfs_server" {
  value = module.nfs_storage.nfs_storage_persistent_volume_claim.metadata.0.name
}

output "shared_storage_pvc_size" {
  value = module.nfs_storage.nfs_storage_persistent_volume_claim.spec.0.resources.0.requests.storage
}
