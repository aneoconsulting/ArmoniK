...
You can now run [HTC Mock](https://armonik.readthedocs.io/en/latest/content/user-guide/how-to-use-htc-mock.html) to see a mock utilisation of ArmoniK and verify your installation.
