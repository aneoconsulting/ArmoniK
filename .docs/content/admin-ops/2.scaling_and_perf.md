...
Follow the [golden rule](../user-guide/2.golden-rules.md) of running two separate Prometheus instances:
...
- Avoid any application-level shared state that cannot scale horizontally (see [Application Principles](../user-guide/2.golden-rules.md)).