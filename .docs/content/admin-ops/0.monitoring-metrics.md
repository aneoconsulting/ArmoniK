...
### Task Statuses
Understanding the various task statuses is essential for effective monitoring. The current list of
of the different tasks statuses according to the current version of the ArmoniK Api can be consulted [here](https://armonikapi.readthedocs.io/en/latest/content/api/v1.html#taskstatus).
