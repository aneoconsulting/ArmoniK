...
of the different tasks statuses according to the current versio of the ArmoniK Api can be consulted [here](https://armonikapi.readthedocs.io/en/latest/content/api/v1.html#taskstatus).
