...
The **Metrics Exporter** exposes, in Prometheus format, aggregated metrics based on predefined task statuses. This is the data source used by both KEDA (to scale compute planes up and down) and the Grafana dashboards. These task-status counts are useful to:
