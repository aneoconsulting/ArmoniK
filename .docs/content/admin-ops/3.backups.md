...
| Queue (ActiveMQ / RabbitMQ / SQS / PubSub) | In-flight tasks | Low — see note below |
| Prometheus | Metrics history | Low — recreatable, useful only for historical dashboards |
| Seq / log storage | Structured application logs | Low — useful for post-mortem analysis only |
