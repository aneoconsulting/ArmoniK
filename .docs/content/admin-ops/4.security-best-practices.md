...
This page summarises the security measures recommended for an ArmoniK deployment. For the full list of rules, see the [Golden Rules](../user-guide/2.golden-rules.md).
...
See [How to configure authentication](../user-guide/4.how-to-configure-authentication.md) for the full setup guide.
