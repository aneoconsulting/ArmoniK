...
2. **Open logs** — check the logs for errors from the worker or control plane. On a local deployment, use [Seq](../user-guide/5.how-to-configure-seq.md). On cloud deployments, use the equivalent service (CloudWatch on AWS, Cloud Monitoring on GCP).
