...
Then, you need to ensure ArmoniK's technical installation prerequisites are met. We have prepared a [prerequisites installer](https://github.com/aneoconsulting/ArmoniK/blob/main/tools/installation/prerequisites-installer.sh) script to ease this task, you need to execute it on a terminal
