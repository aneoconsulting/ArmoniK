...
To launch the deployment, go to the [`infrastructure/quick-deploy/localhost/all-in-one`](https://github.com/aneoconsulting/ArmoniK/tree/main/infrastructure/quick-deploy/localhost/all) directory:
