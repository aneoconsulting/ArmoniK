...
The Compute Plane is divided into **partitions**: isolated groups of pods with their own queue, worker image, node selector, and scaling configuration. See the [partitioning guide](./2.how-to-configure-partitions.md) for setup details.
...
See [Personalizing the Admin GUI](./5.configure-gui.md) for configuration options.
