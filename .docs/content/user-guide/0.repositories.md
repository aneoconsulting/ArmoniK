...
|---|---|
| [ArmoniK](https://github.com/aneoconsulting/ArmoniK) | Deployment configuration (this repo) — top-level Terraform configurations that wire together modules from ArmoniK.Infra, deployment scripts, `parameters.tfvars` |
